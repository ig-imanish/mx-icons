...
export default function HazardLightsOffFilledLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGpyE27bmv">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 10l4 7h-8Z" stroke="currentColor" fill="currentColor" stroke-dasharray="28" fill-opacity="0">
				...
				<g fill="none">
					<path d="M12 10l4 7h-8Z" stroke="currentColor" opacity="0">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGpyE27bmv)" />
