...
export default function TransmissionBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M12 6V13M12 18V16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M4 18V11M4 6V8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M20 6V8C20 9.88562 20 10.8284 19.4142 11.4142C18.8284 12 17.8856 12 16 12H10M4 12H6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
