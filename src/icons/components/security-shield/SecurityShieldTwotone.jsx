...
export default function SecurityShieldTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M3 11L12 8L21 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M12 2V21.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
