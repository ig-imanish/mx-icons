...
export default function BedsideTable4Twotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M15 12V15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M9 12V15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      ...
      <path opacity="0.5" d="M12 20V8M2 8H22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
