...
export default function FilterOffFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGK9slkeuP">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M5 4h14l-5 6.5v9.5l-4 -4v-5.5Z" stroke="currentColor" fill="currentColor" stroke-dasharray="54" fill-opacity="0">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGK9slkeuP)" />
