...
export default function FilterConfirmTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
		<path d="M3 4h14l-5 6.5v9.5l-4 -4v-5.5Z" fill="currentColor" fill-opacity="0" stroke-dasharray="54">
		...
		<path d="M16 18l2 2l3.5 -3.5" fill="none" stroke-dasharray="10" stroke-dashoffset="10">
