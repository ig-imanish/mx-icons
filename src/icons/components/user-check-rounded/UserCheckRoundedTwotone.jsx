...
export default function UserCheckRoundedTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M15.6665 18L16.5 19L18.3332 17.1111" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
