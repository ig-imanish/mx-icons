...
export default function Shop2Linear({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M20 22V11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M4 22V11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
