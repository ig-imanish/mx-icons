...
export default function VideoFramePlayHorizontalBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M21.5 17L2.5 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M21.5 7L2.5 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M12 2L12 7M12 22L12 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M17 2.5L17 7M17 21.5L17 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M7 2.5L7 7M7 21.5L7 17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
