...
export default function GamepadOldTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M8 10V14M6 12L10 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <g opacity="0.5">
      ...
      <path opacity="0.5" d="M12 4V3C12 2.44772 12.4477 2 13 2H14C14.5523 2 15 1.55228 15 1V0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
