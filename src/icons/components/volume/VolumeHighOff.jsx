...
export default function VolumeHighOff({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGcg4Ntd2O">
			<path d="M4 10h3.5l3.5 -3.5v10.5l-3.5 -3.5h-3.5Z" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="34">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGcg4Ntd2O)" />
