...
export default function VolumeRemoveTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
		<path d="M4 10h3.5l3.5 -3.5v10.5l-3.5 -3.5h-3.5Z" fill="currentColor" fill-opacity="0" stroke-dasharray="34">
