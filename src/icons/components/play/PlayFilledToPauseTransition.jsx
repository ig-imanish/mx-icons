...
export default function PlayFilledToPauseTransition({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M9 18l-2 0l0 -12l2 0l0 12M15 6l2 0l0 12l-2 0l0 -12" stroke="currentColor" fill="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
