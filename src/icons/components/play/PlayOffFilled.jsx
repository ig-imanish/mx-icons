...
export default function PlayOffFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGeLflBcRQ">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M8 6l10 6l-10 6Z" stroke="currentColor" fill="currentColor" stroke-dasharray="38" fill-opacity="0">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGeLflBcRQ)" />
