...
export default function CloudAltUploadLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
	...
	<path d="M10.5 16h3v0h2.5l-4 0l-4 0h2.5Z" fill="currentColor">
		<animate attributeName="d" begin="0.6s" dur="0.4s" fill="freeze" keyTimes="0;0.4;1" values="M10.5 16h3v0h2.5l-4 0l-4 0h2.5Z;M10.5 16h3v0h2.5l-4 -4l-4 4h2.5Z;M10.5 16h3v-3h2.5l-4 -4l-4 4h2.5Z" />
		<animate attributeName="d" begin="1s" dur="1.5s" repeatCount="indefinite" keyTimes="0;0.25;0.75;1" values="M10.5 16h3v-3h2.5l-4 -4l-4 4h2.5Z;M10.5 16h3v-4h2.5l-4 -4l-4 4h2.5Z;M10.5 16h3v-2h2.5l-4 -4l-4 4h2.5Z;M10.5 16h3v-3h2.5l-4 -4l-4 4h2.5Z" />
	</path>
    </Icon>
  );
}
