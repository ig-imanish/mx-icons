...
export default function CloudAltUploadFilledLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
      ...
      <defs>
		<mask id="SVGHpxBNeHO">
			...
			<path d="M10 17h4v0h3l-5 0l-5 0h3Z" fill="currentColor">
				...
				<animate attributeName="d" begin="1.5s" dur="1.5s" repeatCount="indefinite" keyTimes="0;0.25;0.75;1" values="M10 17h4v-4h3l-5 -5l-5 5h3Z;M10 17h4v-5h3l-5 -5l-5 5h3Z;M10 17h4v-3h3l-5 -5l-5 5h3Z;M10 17h4v-4h3l-5 -5l-5 5h3Z" />
			</path>
		</mask>
	</defs>
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGHpxBNeHO)" />
    </Icon>
  );
}
