...
export default function CloudAltPrintFilledLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
	...
	<g fill="currentColor">
		<path d="M0 0h24v24H0z" mask="url(#SVGvpgdHbjd)" />
		<path d="M9 12h6v1h-6ZM9 12h6v1h-6ZM9 12h6v1h-6ZM9 12h6v1h-6Z" opacity="0">
			...
			<animate attributeName="d" begin="1.9s" dur="0.4s" repeatCount="indefinite" values="M9 12h6v1h-6ZM9 14h6v1h-6ZM9 16h6v1h-6ZM9 18h6v1h-6Z;M9 14h6v1h-6ZM9 16h6v1h-6ZM9 18h6v1h-6ZM9 20h6v1h-6Z" />
		</path>
	</g>
    </Icon>
  );
