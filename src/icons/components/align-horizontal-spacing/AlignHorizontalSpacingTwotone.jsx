...
export default function AlignHorizontalSpacingTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path opacity="0.5" d="M3 2L3 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M21 2L21 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
