...
export default function SecurityShieldCrossTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M14.5 9.5L9.50002 14.5M9.5 9.49998L14.5 14.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
