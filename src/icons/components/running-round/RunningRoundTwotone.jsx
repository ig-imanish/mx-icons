...
export default function RunningRoundTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M9 17L8.74064 17.3112C7.32089 19.0149 5.21773 20 3 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M16 12C17.3131 12.3283 18.6869 12.3283 20 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
