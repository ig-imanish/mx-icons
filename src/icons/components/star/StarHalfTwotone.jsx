...
export default function StarHalfTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
	...
	<path d="M12 3l-2.35 5.76l-6.21 0.46l4.76 4.02l-1.49 6.04l5.29 -3.28" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="34">
