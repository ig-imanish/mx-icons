...
export default function Closet2Twotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M15 9V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M9 9V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
