...
export default function SecurityOffTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGliTBdchM">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 2l-8 3.5v6.5c0 3.5 3.5 8 8 10c4.5 -1 8 -6.5 8 -10v-6.5l-8 -3.5Z" stroke="currentColor" fill="currentColor" fill-opacity="0" stroke-dasharray="60">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGliTBdchM)" />
