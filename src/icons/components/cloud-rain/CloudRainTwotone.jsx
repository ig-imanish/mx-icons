...
export default function CloudRainTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M16 15.5L14 17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M12 20L10 22" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M11.5 15.5L9.5 17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M7.5 19L5.5 21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
