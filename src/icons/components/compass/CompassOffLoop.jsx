...
export default function CompassOffLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGValGbbsZ">
			...
			<path d="M11 11l1 1l1 1l-1 -1Z" fill="currentColor" transform="rotate(-180 12 12)">
				...
				<animateTransform attributeName="transform" type="rotate" begin="0.6s" dur="9s" repeatCount="indefinite" keyTimes="0;0.8;0.3;0.36;0.42;0.5;0.58;0.65;0.76;0.84;0.92;1" values="-180 12 12;0 12 12;0 12 12;270 12 12;-90 12 12;0 12 12;-180 12 12;-35 12 12;-45 12 12;-110 12 12;-135 12 12;-180 12 12" />
			</path>
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGValGbbsZ)" />
