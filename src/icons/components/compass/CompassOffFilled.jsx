...
export default function CompassOffFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGfgSXqdph">
			...
			<path d="M11 11l1 1l1 1l-1 -1Z" fill="currentColor" transform="rotate(-180 12 12)">
				...
				<animateTransform attributeName="transform" type="rotate" begin="1.1s" dur="0.5s" fill="freeze" values="-180 12 12;0 12 12" />
			</path>
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGfgSXqdph)" />
