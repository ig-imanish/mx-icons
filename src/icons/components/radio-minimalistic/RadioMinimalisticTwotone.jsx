...
export default function RadioMinimalisticTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <circle opacity="0.5" cx="8" cy="14" r="3" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M13.5 11H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M13.5 14H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
