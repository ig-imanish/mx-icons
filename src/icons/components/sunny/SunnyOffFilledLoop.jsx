...
export default function SunnyOffFilledLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGbpuV0dem">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 7c2.76 0 5 2.24 5 5c0 2.76 -2.24 5 -5 5c-2.76 0 -5 -2.24 -5 -5c0 -2.76 2.24 -5 5 -5Z" stroke="currentColor" fill="currentColor" stroke-dasharray="34" fill-opacity="0">
				...
				<g fill="none">
					<g stroke="currentColor">
						<path d="M12 21v1M21 12h1M12 3v-1M3 12h-1" opacity="0">
							...
							<animate attributeName="d" begin="1s" dur="0.2s" fill="freeze" values="M12 19v1M19 12h1M12 5v-1M5 12h-1;M12 21v1M21 12h1M12 3v-1M3 12h-1" />
						</path>
						<path d="M18.5 18.5l0.5 0.5M18.5 5.5l0.5 -0.5M5.5 5.5l-0.5 -0.5M5.5 18.5l-0.5 0.5" opacity="0">
							...
							<animate attributeName="d" begin="1.2s" dur="0.2s" fill="freeze" values="M17 17l0.5 0.5M17 7l0.5 -0.5M7 7l-0.5 -0.5M7 17l-0.5 0.5;M18.5 18.5l0.5 0.5M18.5 5.5l0.5 -0.5M5.5 5.5l-0.5 -0.5M5.5 18.5l-0.5 0.5" />
						</path>
					</g>
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGbpuV0dem)" />
