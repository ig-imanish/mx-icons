...
export default function SunnyFilledLoopToMoonFilledAltLoopTransition({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGKN9G9dDV">
			...
			<path d="M18 -4c5.52 0 10 4.48 10 10c0 5.52 -4.48 10 -10 10c-5.52 0 -10 -4.48 -10 -10c0 -5.52 4.48 -10 10 -10Z" fill="currentColor">
	...
	<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="4">
