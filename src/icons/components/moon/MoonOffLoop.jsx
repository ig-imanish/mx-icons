...
export default function MoonOffLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGtv5SudhO">
			<path d="M7 6c0 6.08 4.92 11 11 11c0.53 0 1.05 -0.04 1.56 -0.11c-1.61 2.47 -4.39 4.11 -7.56 4.11c-4.97 0 -9 -4.03 -9 -9c0 -3.17 1.64 -5.95 4.11 -7.56c-0.07 0.51 -0.11 1.03 -0.11 1.56Z" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="56">
			...
			<g fill="currentColor">
				<path d="M15.22 6.03l2.53 -1.94l-3.19 -0.09l-1.06 -3l-1.06 3l-3.19 0.09l2.53 1.94l-0.91 3.06l2.63 -1.81l2.63 1.81l-0.91 -3.06Z" opacity="0">
					<animate attributeName="opacity" begin="1.1s" dur="6s" repeatCount="indefinite" keyTimes="0;0.1;0.4;0.5;1" values="0;1;1;0;0" />
				</path>
				<path d="M19.61 12.25l1.64 -1.25l-2.06 -0.05l-0.69 -1.95l-0.69 1.95l-2.06 0.05l1.64 1.25l-0.59 1.98l1.7 -1.17l1.7 1.17l-0.59 -1.98Z" opacity="0">
					<animate attributeName="opacity" begin="1.1s" dur="6s" repeatCount="indefinite" keyTimes="0;0.2;0.3;0.6;0.7;1" values="0;0;1;1;0;0" />
				</path>
				<path d="M13.61 5.25l1.64 -1.25l-2.06 -0.05l-0.69 -1.95l-0.69 1.95l-2.06 0.05l1.64 1.25l-0.59 1.98l1.7 -1.17l1.7 1.17Z" opacity="0">
					<animate attributeName="opacity" begin="4.1s" dur="6s" repeatCount="indefinite" keyTimes="0;0.1;0.4;0.5;1" values="0;1;1;0;0" />
				</path>
				<path d="M20.83 9.73l1.88 -1.44l-2.37 -0.07l-0.79 -2.22l-0.79 2.23l-2.37 0.07l1.88 1.44l-0.68 2.27l1.95 -1.34l1.95 1.34Z" opacity="0">
					<animate attributeName="opacity" begin="4.1s" dur="6s" repeatCount="indefinite" keyTimes="0;0.2;0.3;0.6;0.7;1" values="0;0;1;1;0;0" />
				</path>
			</g>
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGtv5SudhO)" />
