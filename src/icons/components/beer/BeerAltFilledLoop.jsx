...
export default function BeerAltFilledLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGYVwL1INE">
			...
			<path d="M18 23c-2 0 -3 2 -5 2c-2 0 -3 -2 -5 -2c-2 0 -3 2 -5 2c-2 0 -3 -2 -5 -2c-2 0 -3 2 -5 2v15h25Z" fill="currentColor">
				<animateTransform attributeName="transform" type="translate" dur="3s" repeatCount="indefinite" values="0;10" />
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGYVwL1INE)" />
