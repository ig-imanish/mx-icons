...
export default function BillListBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M17 14.5H16M10.5 14.5H13.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M17 7.5H14M10.5 7.5H11.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
