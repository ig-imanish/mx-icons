...
export default function FlashlightOnTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M4.5 11H19.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M12 5V2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      ...
      <path opacity="0.5" d="M12 19V21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
