...
export default function MapMarkerAltOffFilledLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGO3BBgTZA">
			<path d="M12 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" stroke="currentColor" fill="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill-opacity="0">
				<animate attributeName="d" dur="0.4s" fill="freeze" keyTimes="0;0.7;1" values="M12 20.5c0 0 -1 -1.5 -1 -2.5c0 -0.5 0.5 -1 1 -1c0.5 0 1 0.5 1 1c0 1 -1 2.5 -1 2.5Z;M12 20.5c0 0 -7 -7.5 -7 -12.5c0 -3.5 3 -7 7 -7c4 0 7 3.5 7 7c0 5 -7 12.5 -7 12.5Z;M12 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" />
			...
			<circle cx="12" cy="9" fill="currentColor">
				<animate attributeName="r" begin="0.9s" dur="0.2s" fill="freeze" to="2.5" />
			</circle>
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGO3BBgTZA)" />
