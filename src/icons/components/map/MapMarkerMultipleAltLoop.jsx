...
export default function MapMarkerMultipleAltLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGvLZ5Ao0D)" />
	<path d="M14 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
		<animate attributeName="d" dur="0.4s" fill="freeze" keyTimes="0;0.7;1" values="M14 20.5c0 0 -1 -1.5 -1 -2.5c0 -0.5 0.5 -1 1 -1c0.5 0 1 0.5 1 1c0 1 -1 2.5 -1 2.5Z;M14 20.5c0 0 -7 -7.5 -7 -12.5c0 -3.5 3 -7 7 -7c4 0 7 3.5 7 7c0 5 -7 12.5 -7 12.5Z;M14 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" />
		<animateTransform attributeName="transform" type="rotate" dur="3s" repeatCount="indefinite" keyTimes="0;0.3;0.4;0.54;0.6;0.68;0.7;1" values="0 14 20.5;0 14 20.5;-8 14 20.5;0 14 20.5;5 14 20.5;-2 14 20.5;0 14 20.5;0 14 20.5" />
	</path>
	<circle cx="14" cy="9" fill="currentColor">
		<animate attributeName="r" begin="0.4s" dur="0.2s" fill="freeze" to="2.5" />
	</circle>
    </Icon>
  );
}
