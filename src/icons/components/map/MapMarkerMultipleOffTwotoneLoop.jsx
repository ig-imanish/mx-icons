...
export default function MapMarkerMultipleOffTwotoneLoop({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
		...
		<mask id="SVGNBTP0dpl">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="48">
				<path d="M10 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" stroke="currentColor" fill="currentColor" stroke-width="2" fill-opacity="0">
					...
					<animateTransform attributeName="transform" type="rotate" dur="3s" repeatCount="indefinite" keyTimes="0;0.3;0.4;0.54;0.6;0.68;0.7;1" values="0 10 20.5;0 10 20.5;-8 10 20.5;0 10 20.5;5 10 20.5;-2 10 20.5;0 10 20.5;0 10 20.5" />
				...
				<path d="M14 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" stroke="currentColor" fill="currentColor" stroke-width="4" fill-opacity="0">
					<animate attributeName="stroke-dashoffset" dur="0.6s" fill="freeze" values="48;0" />
					<animateTransform attributeName="transform" type="rotate" dur="3s" repeatCount="indefinite" keyTimes="0;0.3;0.4;0.54;0.6;0.68;0.7;1" values="0 14 20.5;0 14 20.5;-8 14 20.5;0 14 20.5;5 14 20.5;-2 14 20.5;0 14 20.5;0 14 20.5" />
					<animate attributeName="fill-opacity" begin="0.7s" dur="0.15s" fill="freeze" to="1" />
				</path>
			</g>
			<g fill="currentColor">
				<path d="M14 20.5c0 0 -6 -7 -6 -11.5c0 -3.31 2.69 -6 6 -6c3.31 0 6 2.69 6 6c0 4.5 -6 11.5 -6 11.5Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill-opacity="0" stroke-dasharray="48">
					<animate attributeName="stroke-dashoffset" dur="0.6s" fill="freeze" values="48;0" />
					<animateTransform attributeName="transform" type="rotate" dur="3s" repeatCount="indefinite" keyTimes="0;0.3;0.4;0.54;0.6;0.68;0.7;1" values="0 14 20.5;0 14 20.5;-8 14 20.5;0 14 20.5;5 14 20.5;-2 14 20.5;0 14 20.5;0 14 20.5" />
					<animate attributeName="fill-opacity" begin="0.7s" dur="0.15s" fill="freeze" to="0.3" />
				</path>
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGNBTP0dpl)" />
