...
export default function UploadOff({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGt9NWldhg">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 15h2v-6h2.5l-4.5 -4.5M12 15h-2v-6h-2.5l4.5 -4.5" stroke="currentColor" fill="currentColor" stroke-dasharray="20" fill-opacity="0">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGt9NWldhg)" />
