...
export default function SocketTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M12 18.0001V16.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M12 7.5V6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
