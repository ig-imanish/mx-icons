...
export default function ComputerOffFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
		...
		<mask id="SVGJ9dVmkHP">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<g stroke="currentColor">
					...
					<path d="M12 17h-9v-12h18v12Z" fill="currentColor" stroke-dasharray="62" stroke-dashoffset="62" fill-opacity="0">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGJ9dVmkHP)" />
