...
export default function MarkerTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
		<path d="M6 14l11 -11l4 4l-11 11l-4 -4Z" fill="none" stroke-width="2" stroke-dasharray="46">
			<animate attributeName="stroke-dashoffset" dur="0.5s" fill="freeze" values="46;0" />
		</path>
		<path d="M9 17l-2.5 2.5l-4 0l4.5 -4.5Z" fill="currentColor" fill-opacity="0" opacity="0">
