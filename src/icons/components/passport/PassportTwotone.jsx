...
export default function PassportTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <circle opacity="0.5" cx="12" cy="13" r="3" stroke="#1C274D" strokeWidth="1.5"/>
      ...
      <path opacity="0.5" d="M10 19H14" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
