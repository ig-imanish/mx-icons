...
export default function FolderOffTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGTH9wC1vo">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 7h8c0.55 0 1 0.45 1 1v10c0 0.55 -0.45 1 -1 1h-16c-0.55 0 -1 -0.45 -1 -1v-11Z" stroke="currentColor" fill="currentColor" fill-opacity="0" stroke-dasharray="62">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGTH9wC1vo)" />
