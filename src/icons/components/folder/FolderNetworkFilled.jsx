...
export default function FolderNetworkFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
		<path d="M12 6h7c0.55 0 1 0.45 1 1v8c0 0.55 -0.45 1 -1 1h-14c-0.55 0 -1 -0.45 -1 -1v-9Z" fill="currentColor" stroke-dasharray="54" fill-opacity="0">
		...
		<g fill="none">
			...
			<path d="M10 20h4v2h-4Z" opacity="0">
				<set attributeName="opacity" to="1" begin="1.7s" fill="freeze" />
				<animate attributeName="d" begin="1.7s" dur="0.2s" fill="freeze" values="M12 21h0v0h0Z;M10 20h4v2h-4Z" />
			</path>
		</g>
	</g>
    </Icon>
