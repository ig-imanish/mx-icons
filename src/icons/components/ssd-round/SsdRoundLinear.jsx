...
export default function SsdRoundLinear({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M18 17V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M15.5 17V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M13 17V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M10.5 17V18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
