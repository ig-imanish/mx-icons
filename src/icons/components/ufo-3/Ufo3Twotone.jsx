...
export default function Ufo3Twotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <circle cx="12" cy="12.0002" r="1" transform="rotate(45 12 12.0002)" fill="#8E93A6"/>
      ...
      <path d="M10 22L12.7072 19.7777" stroke="#8E93A6" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M2 14L4.22192 11.293" stroke="#8E93A6" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
