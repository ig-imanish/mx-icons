...
export default function LightbulbTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M12 17V15M12 15C12.7403 15 13.3866 14.5978 13.7324 14M12 15C11.2597 15 10.6134 14.5978 10.2676 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
