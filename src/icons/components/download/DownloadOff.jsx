...
export default function DownloadOff({
  ...
  return (
      ...
      <defs>
		<mask id="SVGHLslwoSL">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 4h2v6h2.5l-4.5 4.5M12 4h-2v6h-2.5l4.5 4.5" stroke="currentColor" fill="currentColor" stroke-dasharray="20" fill-opacity="0">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGHLslwoSL)" />
