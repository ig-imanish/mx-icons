...
export default function CheckList3Twotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
		<g fill="currentColor" stroke-dasharray="24">
			<path d="M11.5 5c0 -0.83 0.67 -1.5 1.5 -1.5h6c0.83 0 1.5 0.67 1.5 1.5c0 0.83 -0.67 1.5 -1.5 1.5h-6c-0.83 0 -1.5 -0.67 -1.5 -1.5Z" fill-opacity="0">
			...
			<path d="M11.5 12c0 -0.83 0.67 -1.5 1.5 -1.5h6c0.83 0 1.5 0.67 1.5 1.5c0 0.83 -0.67 1.5 -1.5 1.5h-6c-0.83 0 -1.5 -0.67 -1.5 -1.5Z" fill-opacity="0" stroke-dashoffset="24">
				<animate attributeName="stroke-dashoffset" begin="0.4s" dur="0.3s" fill="freeze" to="0" />
				<animate attributeName="fill-opacity" begin="1.2s" dur="0.15s" fill="freeze" to="0.3" />
			</path>
			<path d="M11.5 19c0 -0.83 0.67 -1.5 1.5 -1.5h6c0.83 0 1.5 0.67 1.5 1.5c0 0.83 -0.67 1.5 -1.5 1.5h-6c-0.83 0 -1.5 -0.67 -1.5 -1.5Z" fill-opacity="0" stroke-dashoffset="24">
				<animate attributeName="stroke-dashoffset" begin="0.8s" dur="0.3s" fill="freeze" to="0" />
				<animate attributeName="fill-opacity" begin="1.2s" dur="0.15s" fill="freeze" to="0.3" />
			</path>
		</g>
		<g fill="none" stroke-width="2" stroke-dasharray="12">
