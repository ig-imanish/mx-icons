...
export default function PassportMinimalisticTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M4 6V19C4 20.6569 5.34315 22 7 22H17C18.6569 22 20 20.6569 20 19V9C20 7.34315 18.6569 6 17 6H4ZM4 6V5" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
      <circle opacity="0.5" cx="12" cy="14" r="3" stroke="#1C274D" strokeWidth="1.5"/>
