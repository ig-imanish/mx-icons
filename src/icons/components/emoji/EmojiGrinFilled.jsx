...
export default function EmojiGrinFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
    ...
    >
      <defs>
		<mask id="SVGN5Rh5bUL">
			...
			<path d="M12 15c-2.5 0 -3.25 0 -4 0c-0.55 0 -1 0 -1 0c0 0 1.5 0 5 0c3.5 0 5 0 5 0c0 0 -0.45 0 -1 0c-0.75 0 -1.5 0 -4 0Z" fill="currentColor">
				<animate attributeName="d" begin="1.5s" dur="0.2s" fill="freeze" to="M12 14c-2.5 0 -3.25 -1 -4 -1c-0.55 0 -1 0.45 -1 1c0 0.75 1.5 4 5 4c3.5 0 5 -3.25 5 -4c0 -0.55 -0.45 -1 -1 -1c-0.75 0 -1.5 1 -4 1Z" />
			</path>
		</mask>
	</defs>
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGN5Rh5bUL)" />
    </Icon>
  );
}
