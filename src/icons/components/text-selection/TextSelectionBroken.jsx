...
export default function TextSelectionBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M18 4H6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M20 18L20 12M20 6V8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M18 20L12 20M6 20L8 20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
