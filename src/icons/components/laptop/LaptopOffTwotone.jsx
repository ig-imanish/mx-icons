...
export default function LaptopOffTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVG9ejUycFX">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M12 17h-7v-10h14v10Z" stroke="currentColor" fill="currentColor" fill-opacity="0" stroke-dasharray="50">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVG9ejUycFX)" />
