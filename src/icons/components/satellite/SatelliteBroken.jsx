...
export default function SatelliteBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M20.4692 10.9182C20.4692 10.9182 18.6222 10.3027 16.1595 7.8401C13.6969 5.37747 13.0813 3.53027 13.0813 3.53027" stroke="currentColor" strokeWidth="1.5"/>
      ...
      <path d="M2 9.68721L5 8.02051M14.3132 22.0003L16.5 18.0005M5 19.0003L9 15.0004" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
