...
export default function ValignBottomTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
		...
		<path d="M12 9h6v12h-12v-12Z" fill="currentColor" stroke-width="2" fill-opacity="0" stroke-dasharray="50" stroke-dashoffset="50">
