...
export default function VideoMicrophoneTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M13 8L17 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M13 11L17 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
