...
export default function HomeSimpleTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M6 8l6 -5l6 5v12h-12v-12Z" fill="currentColor" fill-opacity="0">
	...
	<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
		...
		<path d="M2 10l10 -8l10 8" stroke-dasharray="28" stroke-dashoffset="28">
			<animate attributeName="stroke-dashoffset" begin="0.6s" dur="0.6s" fill="freeze" to="0" />
		</path>
	</g>
    </Icon>
  );
