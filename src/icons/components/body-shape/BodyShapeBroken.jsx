...
export default function BodyShapeBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M5.5 13H9M18 13H13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M6 11H12M18 11H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
