...
export default function BodyShapeTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M6 13H18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M6 11H18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
