...
export default function BodyShapeLinear({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M6 13H18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M6 11H18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
