...
export default function FileDownloadFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
    ...
    >
      <defs>
		<mask id="SVG203jfdxe">
			...
			<path d="M12 19l4 -4h-2.5v-3h-3v3h-2.5Z" fill="currentColor" opacity="0">
				<set attributeName="opacity" to="1" begin="1.1s" fill="freeze" />
				<animate attributeName="d" begin="1.1s" dur="0.2s" fill="freeze" values="M12 12l4 0h-2.5v0h-3v0h-2.5Z;M12 19l4 -4h-2.5v-3h-3v3h-2.5Z" />
			</path>
		</mask>
	</defs>
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVG203jfdxe)" />
    </Icon>
  );
}
