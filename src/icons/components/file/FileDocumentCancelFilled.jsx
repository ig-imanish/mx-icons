...
export default function FileDocumentCancelFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGL3yhnbEw">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				...
				<g fill="none">
					<path d="M13.5 3l5.5 5.5" stroke="currentColor" opacity="0">
						<set attributeName="opacity" to="1" begin="0.6s" fill="freeze" />
					</path>
					<g stroke="currentColor">
						<path d="M7 13h10" stroke-dasharray="12" stroke-dashoffset="12">
							<animate attributeName="stroke-dashoffset" begin="1.1s" dur="0.2s" fill="freeze" to="0" />
						</path>
						<path d="M7 17h7" stroke-dasharray="10" stroke-dashoffset="10">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGL3yhnbEw)" />
