...
export default function FileImportTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <g fill="currentColor">
		...
		<path d="M11 10l3 3l2 -2l0 7l-7 0l2 -2l-3 -3Z" opacity="0">
			<set attributeName="opacity" to="1" begin="0.8s" fill="freeze" />
			<animate attributeName="d" begin="0.8s" dur="0.2s" fill="freeze" values="M11 10l0 0l2 -2l-3.5 3.5l-3.5 3.5l2 -2l0 0Z;M11 10l3 3l2 -2l0 7l-7 0l2 -2l-3 -3Z" />
		</path>
	</g>
    </Icon>
  );
