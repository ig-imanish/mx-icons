...
export default function FileExportFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
    ...
    >
      <defs>
		<mask id="SVGrpzvDdEW">
			...
			<path d="M8 16l3 -3l-2 -2l7 0l0 7l-2 -2l-3 3Z" fill="currentColor" opacity="0">
				<set attributeName="opacity" to="1" begin="1.1s" fill="freeze" />
				<animate attributeName="d" begin="1.1s" dur="0.2s" fill="freeze" values="M8 16l0 0l-2 -2l3.5 3.5l3.5 3.5l-2 -2l0 0Z;M8 16l3 -3l-2 -2l7 0l0 7l-2 -2l-3 3Z" />
			</path>
		</mask>
	</defs>
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGrpzvDdEW)" />
    </Icon>
  );
}
