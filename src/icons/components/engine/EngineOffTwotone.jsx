...
export default function EngineOffTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
      ...
      <defs>
		<mask id="SVGfc7JzeMu">
			<g stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				<path d="M11 9h6v10h-6.5l-2 -2h-2.5v-6.5l1.5 -1.5Z" stroke="currentColor" fill="currentColor" fill-opacity="0" stroke-dasharray="42">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGfc7JzeMu)" />
