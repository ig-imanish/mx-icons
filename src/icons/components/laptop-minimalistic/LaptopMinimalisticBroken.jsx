...
export default function LaptopMinimalisticBroken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M22 21H16M2 21H12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M15 15H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
