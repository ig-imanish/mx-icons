...
export default function PlusMinusTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M18 17H13" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M10.5 8.00002H8M8 8.00002L5.5 8.00002M8 8.00002L8 5.5M8 8.00002L8 10.5" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
