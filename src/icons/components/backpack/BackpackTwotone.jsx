...
export default function BackpackTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M17.5 15.5V17" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M15.9585 4.5C15.7205 3.08114 14.4865 2 13 2H11C9.51353 2 8.27954 3.08114 8.0415 4.5" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M3 14C8.72979 16.5466 15.2702 16.5466 21 14" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M10 13H14" stroke="#1C274D" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
