...
export default function PointOnMapPerspectiveLinear({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M21 21L3 11" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M3.5 21L12 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
