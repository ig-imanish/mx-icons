...
export default function VideoFrameCutLinear({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M3.5 8.5H7M20.5 8.5H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M3.5 15.5H7M20.5 15.5H17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
