...
export default function MonitorSmallOff({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGzVTWDbMx">
			<path d="M12 17h-8v-14h16v14Z" stroke="currentColor" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="62">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGzVTWDbMx)" />
