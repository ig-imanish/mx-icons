...
export default function MonitorArrowDownFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      <defs>
		<mask id="SVGplF1PeGD">
			<g fill="currentColor">
				<path d="M12 17h-10v-14h20v14Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="70" fill-opacity="0">
			...
			<g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				...
				<g stroke="currentColor" stroke-dasharray="8">
					<path d="M12 7v6" stroke-dashoffset="8">
						<animate attributeName="stroke-dashoffset" begin="1.7s" dur="0.2s" fill="freeze" to="0" />
					</path>
					<path d="M12 13l3 -3M12 13l-3 -3" stroke-dashoffset="8">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGplF1PeGD)" />
    </Icon>
  );
}
