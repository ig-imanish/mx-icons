...
export default function MonitorScreenshotFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
      ...
      <defs>
		<mask id="SVGuZ6iB2MN">
			...
			<g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				...
				<path d="M6 7h2M6 7v2M18 13h-2M18 13v-2" stroke="currentColor" stroke-dasharray="4" stroke-dashoffset="4">
					<animate attributeName="stroke-dashoffset" begin="1.7s" dur="0.2s" fill="freeze" to="0" />
				</path>
			</g>
		</mask>
	</defs>
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGuZ6iB2MN)" />
    </Icon>
  );
}
