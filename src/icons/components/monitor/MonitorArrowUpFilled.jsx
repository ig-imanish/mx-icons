...
export default function MonitorArrowUpFilled({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
		...
		<mask id="SVGpeF1qecy">
			...
			<g fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
				...
				<g stroke="currentColor" stroke-dasharray="8">
					<path d="M12 13v-6" stroke-dashoffset="8">
						<animate attributeName="stroke-dashoffset" begin="1.7s" dur="0.2s" fill="freeze" to="0" />
					</path>
					<path d="M12 7l3 3M12 7l-3 3" stroke-dashoffset="8">
	...
	<path d="M0 0h24v24H0z" fill="currentColor" mask="url(#SVGpeF1qecy)" />
    </Icon>
  );
}
