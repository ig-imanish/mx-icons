...
export default function CartLarge4Broken({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path d="M9.5 9L10.0282 12.1179" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M15.5283 9L15.0001 12.1179" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
