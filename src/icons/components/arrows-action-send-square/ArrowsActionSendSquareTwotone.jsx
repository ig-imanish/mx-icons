...
export default function ArrowsActionSendSquareTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M17 12L10 12M10 12L13 15M10 12L13 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M7 16L7 12L7 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
