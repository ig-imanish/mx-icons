...
export default function LightbulbMinimalisticTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path opacity="0.5" d="M10 19.5H14M10.6667 22H13.3333" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
