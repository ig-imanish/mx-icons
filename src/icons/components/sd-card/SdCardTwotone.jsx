...
export default function SdCardTwotone({
  size = 24,
  color = "#292D32",
  className = "",
  ...props
  ...
  return (
    ...
    >
      ...
      <path opacity="0.5" d="M7 6V9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M10 6V9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path opacity="0.5" d="M13 6V9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </Icon>
  );
}
